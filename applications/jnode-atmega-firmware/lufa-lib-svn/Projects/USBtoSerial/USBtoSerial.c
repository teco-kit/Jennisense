...
void SetupHardware(void)
{
  ...
  /* enable clock division, run on 8MHz */
...
#if F_CPU==8000000
  if (CDCInterfaceInfo->State.LineEncoding.BaudRateBPS==1000000)
    UBRR1 = 0;
  else
#endif
...
//    UCSR1A = (1 << U2X1);
//  } else {
//    UBRR1  = SERIAL_UBBRVAL(CDCInterfaceInfo->State.LineEncoding.BaudRateBPS);
//    UCSR1A = 0x00;
//  }
//#endif
